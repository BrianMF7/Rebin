  ...
  volume: ({ className }: IconProps) => (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 14.142M6 8h4l5-5v18l-5-5H6a2 2 0 01-2-2V10a2 2 0 012-2z"
      />
    </svg>
  ),
